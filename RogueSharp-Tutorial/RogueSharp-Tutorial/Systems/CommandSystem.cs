...
public class CommandSystem
{
    ...
    // its false when player couldnt move, such as trying to move into a wall
    ...
    private static int ResolveAttack(Actor attacker, Actor defender, StringBuilder attackMessage)
    {
        ...
        foreach (TermResult termResult in attackResult.Results)
        {
            ...
            // compare the value to 100 minus the attack chance and add a hit if its greater
    ...
    // apply any damage that wasnt blocked to the defender
